...
results = {"Distance explains the majority of the ripple strength correlation variability.":
            ...
            f"Correlation of ∫Ripple across different CA1 regions was highly variable (Figure 1A-B-C) "
            ...
            f"Looking at the relationship between lag and ∫Ripple in long-distance pairs, however, an asymmetric distribution was apparent (Figure 1F top), "
            ...
            f"To further investigate this relationship we divided ripples into two groups: strong (top 10% ∫Ripple per session at the reference location) "
            ...
            f". While we found no differences in the amount of ripples detected in each hippocampal section (p-value = {round(p_value_ripples_per_section, 2)}, Kruskal-Wallis test), "
