...
results = {"Distance explains most of the ripple strength correlation variability.":
           ...
           f'modulated (>25%) only by medial ripples and {data_lat.shape[0]} only by lateral ripples (Supplementary Figure 16). '
           ...
           f'medial ripples elicited significantly more modulation across multiple cortical regions. '
