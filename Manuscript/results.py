...
results = {"Distance explains most of the ripple strength correlation variability.":
           ...
           f'Additionally, '
           f'we found that prior to the onset of ripples, medial ripples induced stronger modulation in ProS and SUB, weaker modulation in DG and '
           ...
           f'difference for either medial or lateral ripples (with absolute modulation of at least 50%). Our analysis revealed that the majority of neurons did '
