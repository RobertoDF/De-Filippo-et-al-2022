...
results = {"Distance explains most of the ripple strength correlation variability.":
            ...
            f"Ripple strength and duration are highly correlated in each session (mean r = {round(r_ripple_duration_amplitude_list.mean()[0],4)} ± "
            f"{round(r_ripple_duration_amplitude_list.sem()[0],4)}, Supplementary Figure 2). "
