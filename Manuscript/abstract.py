...
abstract = "Hippocampal ripples are highly synchronous neural events critical for memory consolidation and retrieval. " \
           ...
           f"We performed an extensive analysis of ripple propagation within the septal half of the hippocampal formation. " \
           "Unexpectedly, strong ripples propagate differentially in the septal and temporal direction along the hippocampal longitudinal axis, " \
           "Thus, the hippocampus is anisotropic in relation to ripple propagation. Hippocampal anisotropy is explained by " \
