...
plt.figure(1).axes[0].texts[0].set_position([0.600000, 0.473120])
plt.figure(1).axes[0].texts[1].set(position=(0.6000000000000001, 0.5930220150660972), text='p-value = 1.55e-04', ha='center', va='center', fontsize=8.0)
