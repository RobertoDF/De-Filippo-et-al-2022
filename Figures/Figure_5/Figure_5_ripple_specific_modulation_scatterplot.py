...
sns.scatterplot(data=summary_units_df_sub[(summary_units_df_sub['Firing rate (0-50 ms) medial']>0.025)&
                                          (summary_units_df_sub['Parent brain region']=='HPF' )],
               x='Ripple modulation (0-50 ms) medial', y= 'Ripple modulation (0-50 ms) lateral', alpha=.5, ax=axs, s=5, hue='Ripple type engagement', palette=palette_ML)
