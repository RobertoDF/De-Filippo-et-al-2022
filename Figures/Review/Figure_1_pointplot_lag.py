...
quant = 0.9
ripples_lags_strong = ripples_lags.groupby(['Session', "Type"]).apply(lambda group: group[group["Duration (s)"] >= group["Duration (s)"].quantile(quant)]).reset_index(drop=True)
ripples_lags_strong["Quantile"] = "Long ripples"

ripples_lags_weak = ripples_lags.groupby(['Session', "Type"]).apply(lambda group: group[group["Duration (s)"] < group["Duration (s)"].quantile(quant)]).reset_index(drop=True)
...
quant = 0.9
ripples_lags_inverted_reference_strong = ripples_lags_inverted_reference.groupby(['Session', "Type"]).apply(lambda group: group[group["Duration (s)"] > group["Duration (s)"].quantile(quant)]).reset_index(drop=True)
ripples_lags_inverted_reference_strong["Quantile"] = "Long ripples"

ripples_lags_inverted_reference_weak = ripples_lags_inverted_reference.groupby(['Session', "Type"]).apply(lambda group: group[group["Duration (s)"] < group["Duration (s)"].quantile(quant)]).reset_index(drop=True)
...
g = sns.pointplot(x="Lag (ms)", y="Reference", hue="Session",
                  data=data[data["Quantile"]=="Long ripples"], dodge=0.3,
                  join=True,
...
gg = sns.pointplot(x="Lag (ms)", y="Reference",
                   data=data[data["Quantile"]=="Long ripples"].groupby(["Session", "Reference"]).mean().reset_index(),
                   join=True,
...
axs[1, 0].set_title("Long ripples", color=palette_timelags["Long ripples"])
...
mwu = pg.mwu(data[(data["Quantile"]== "Long ripples") & (data["Reference"]== "Medial")].groupby("Session").mean()["Lag (ms)"],
                 data[(data["Quantile"]== "Long ripples") & (data["Reference"]== "Lateral")].groupby("Session").mean()["Lag (ms)"])
...
# print(pg.normality(data[data["Quantile"]=="Long ripples"].groupby(["Session", "Reference"]).mean().reset_index(),
#                    dv="Lag (ms)", group="Reference", method="normaltest"))
ttest_lag = pg.ttest(data[(data["Quantile"]== "Long ripples") & (data["Reference"]== "Medial")].groupby("Session").mean()["Lag (ms)"],
                 data[(data["Quantile"]== "Long ripples") & (data["Reference"]== "Lateral")].groupby("Session").mean()["Lag (ms)"])

mwu_lag = pg.mwu(data[(data["Quantile"]== "Long ripples") & (data["Reference"]== "Medial")].groupby("Session").mean()["Lag (ms)"],
                 data[(data["Quantile"]== "Long ripples") & (data["Reference"]== "Lateral")].groupby("Session").mean()["Lag (ms)"])
...
gg = sns.pointplot(x="Lag (ms)", y="Quantile",
                   ...
                   join=True,
                   markers="o", scale=1.5, ci=95, palette=palette_timelags, ax=axs[1, 1], order=["Long ripples", "Common ripples"])
plt.setp(gg.collections, zorder=100)  # for the markers
plt.setp(gg.lines, zorder=100)
...
gg = sns.pointplot(x="Lag (ms)", y="Quantile",
                   ...
                   join=True,
                   markers="o", scale=1.5, ci=95, palette=palette_timelags, ax=axs[0, 1], order=["Long ripples", "Common ripples"])
plt.setp(gg.collections, zorder=100);  # for the markers
plt.setp(gg.lines, zorder=100)
axs[0, 1].set_ylabel('')
...
ttest = pg.ttest(data[(data["Quantile"]== "Long ripples") & (data["Reference"]== "Medial")].groupby("Session").mean()["Lag (ms)"],
...
#                   dv="Lag (ms)", group="Quantile", method="normaltest"))
ttest = pg.ttest(data[(data["Quantile"]== "Long ripples") & (data["Reference"]== "Lateral")].groupby("Session").mean()["Lag (ms)"],
                 data[(data["Quantile"]== "Common ripples") & (data["Reference"]== "Lateral")].groupby("Session").mean()["Lag (ms)"])
mwu = pg.mwu(data[(data["Quantile"]== "Long ripples") & (data["Reference"]== "Lateral")].groupby("Session").mean()["Lag (ms)"],
                 data[(data["Quantile"]== "Common ripples") & (data["Reference"]== "Lateral")].groupby("Session").mean()["Lag (ms)"])
