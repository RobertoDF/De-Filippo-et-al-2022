...
seed_ripples_by_hip_section_summary_long = pd.concat([q[9] for q in out])
seed_ripples_by_hip_section_summary_long = seed_ripples_by_hip_section_summary_long.reset_index().rename(columns={'index': 'Location seed'})
hue_order = ["Medial seed", "Central seed", "Lateral seed"]
order = ["Medial", "Central", "Lateral"]
hue = "Location seed"
x = "Reference"
y = "Percentage seed (%)"
data = seed_ripples_by_hip_section_summary_long
