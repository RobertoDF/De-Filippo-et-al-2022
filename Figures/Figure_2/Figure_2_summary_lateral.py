...
plot_trajs_interp(trajectories_by_strength[trajectories_by_strength["Location"] == "Lateral"], axs, [-35, 30])
...
interp_trajs = interp_trajs[interp_trajs["M-L (µm)"] > 7250 - 5691.510009765625]
