...
seed_ripples_by_hip_section_summary_total = pd.concat([q[0] for q in out])
seed_ripples_by_hip_section_summary_total = seed_ripples_by_hip_section_summary_total.reset_index().rename(columns={'index': 'Location seed'})
hue_order = ["Medial seed", "Central seed", "Lateral seed"]
order = ["Medial", "Central", "Lateral"]
hue = "Location seed"
x = "Reference"
y = "Percentage seed (%)"
data = seed_ripples_by_hip_section_summary_total
