...
plot_trajs_interp_by_seed(trajectories_by_strength[trajectories_by_strength["Location"] == "Medial"], axs, [-40, 35])

interp_trajs = trajectories_by_strength[trajectories_by_strength["Location"] == "Medial"]\
...
interp_trajs = interp_trajs[interp_trajs["M-L (µm)"] < 9250 - 5691.510009765625]
